...
namespace ImGui
{
    ...
    // New: Double drags
    IMGUI_API bool          DragDouble(const char* label, double* v, double v_speed = 1.0, double v_Min = 0.0, double v_max = 0.0, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          DragDouble3(const char* label, double v[3], double v_speed = 1.0, double v_Min = 0.0, double v_max = 0.0, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
